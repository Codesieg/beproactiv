...
class Movies
{
    ...
    public function getBestDirector(): ?string
    {
        return $this->bestDirector;
    }
    ...
    public function setRatio(?string $ratio): ?int
    {
        $this->ratio = $ratio;
        return $this->ratio;
    }

    public function setBestDirector(?string $bestDirector): ?string
    {
