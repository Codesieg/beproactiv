...
class MoviesController extends AbstractController
{
    ...
    public function browse()
    {
        ...
        //         $moviesByYear[] = $movies[$j]->annee_production;
        //     }
        // }
        dd($movies);
        foreach ($movies[0]["annee_production"] as $movie) {
            foreach ($movie as $moviesYears){
                dd($movie["annee_production"], $moviesYears);
                $moviesByYear[] = $moviesYears;
            }
        } 
