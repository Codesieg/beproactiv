...
class MoviesController extends AbstractController
{
    ...
    public function browseSearch()
    {
        ...
        foreach ($movies as $movie) {
            ...
            $movieName = strpos($movie["nom"], strtoupper($search));
            $movieName = strpos($movie["realisateur"], strtoupper($search));
            $movieDirector = strpos($movie["realisateur"] , preg_match('$regex', $search));
            dump($movieDirector);
            if ($movie["nom"] == $movieName || $movie['realisateur'] == $movieDirector){
