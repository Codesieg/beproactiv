...
function initFunction() {
    ...
    let endpoint = 'http://localhost:8080/browse';
    ...
    //envoyer la requete
    fetch(endpoint)
        .then(response.json()) // nous convertissons la réponse json en objet
        .then(console.log(response.json)); // on affiche les taches
}